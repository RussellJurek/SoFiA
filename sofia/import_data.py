...
def read_data(inFile, weightsFile, maskFile, weightsFunction = None):
	...
	if weightsFile:
		...
		# WARNING: This entire implementation is currently insufficient for the reasons given further down!
		...
		if whitelistBreached:
			...
			try:
				...
				np_Weighted_cube = np_Cube * eval(str(weightsFunction))
			...
			# Replace input cube with weighted cube:
			np_Cube = np_Weighted_cube
			del np_Weighted_cube
